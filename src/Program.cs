...
namespace Microsoft.Azure.Cosmos.Samples.Bulk
{
    ...
    {
        private const string EndpointUrl = "https://tollboothdb-xuhliu.documents.azure.com:443/";
        private const string AuthorizationKey = "ugeqzA0BRcHlTs7G09ikUSlEIAZukSfFLTuLBowS6PoXRZdbI2Z3xKcUA2TahMPjXMueHlG4ViLGCDtsoEsopA==";
        private const string DatabaseName = "Tasks1";
        private const string ContainerName = "items";
        private const int AmountToInsert = 10;
